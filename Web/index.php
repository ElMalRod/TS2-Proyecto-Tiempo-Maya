...
@media (max-width: 520px) {
    .main-title-glass { font-size: 1.28rem; padding: 0.2em 0.7em;}
}
        ...
        @media (max-width: 520px) {
            .main-title-glass { font-size: 1.22rem; margin-bottom: 1.5rem; }
            .info-line-modern { font-size: 1rem; padding: 0.75rem 0.7rem; }
            .fecha-modern { font-size: 0.97rem; }
        }
        #footer {
            flex-shrink: 0;
            margin-top: 0;
...
<body>
    ...
    <section id="inicio" style="background: url(<?php echo $fondo; ?>) top center;">
        <div style="width: 100%; display: flex; flex-direction: column; align-items: center; min-height: 90vh; justify-content: center;">
